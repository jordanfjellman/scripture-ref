pub const GENESIS_CHAPTER_COUNT: u8 = 50;
pub const GENESIS_CHAPTER_VERSES: [u8; GENESIS_CHAPTER_COUNT as usize] = [
...
pub const EXODUS_CHAPTER_COUNT: u8 = 40;
pub const EXODUS_CHAPTER_VERSES: [u8; EXODUS_CHAPTER_COUNT as usize] = [
